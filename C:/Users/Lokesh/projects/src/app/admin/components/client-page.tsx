...
export function ClientPage({ columns, data, initialRegistrationStatus }: ClientPageProps<Registration, any>) {
    ...
    <div className="space-y-4">
      <div className="flex items-start justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2">
            <RegistrationToggle initialStatus={initialRegistrationStatus} />
